...
import com.cs680.lupusmate.R.string;
import com.cs680.lupusmate.activity.HomeNavigation.NavigationDrawerCallbacks;
...
public class Home extends ActionBarActivity implements
		HomeNavigation.NavigationDrawerCallbacks {

	/**
	 * Fragment managing the behaviors, interactions and presentation of the
	 * navigation drawer.
	 */
	private HomeNavigation mNavigationDrawerFragment;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mNavigationDrawerFragment = (HomeNavigation) getSupportFragmentManager()
